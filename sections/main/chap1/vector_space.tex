...
\begin{proof*}[Proposition \ref{prop:add_vec_to_span}]
...
\begin{proof*}[Corollary \ref{coro:add_ind_vec_to_span}]
...
\begin{proof*}[Proposition \ref{prop:remove_vec_from_span}]
...
\begin{proof*}[Corollary \ref{coro:remove_vec_from_lin_ind_sets}]
